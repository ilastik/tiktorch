...
class SessionManager:
    ...
    def close_session(self, session_id: str) -> None:
        ...
        with self.__lock:
            ...
            for handler in self.__close_handlers_by_sesson_id.pop(session_id, []):
                try:
                    handler(session)
                except Exception:
    ...
    def __init__(self) -> None:
        ...
        self.__close_handlers_by_sesson_id: Dict[str, List[CloseCallback]] = defaultdict(list)
    ...
    def _on_close(self, session: ISession, handler: CloseCallback):
        with self.__lock:
            ...
            self.__close_handlers_by_sesson_id[session.id].append(handler)
