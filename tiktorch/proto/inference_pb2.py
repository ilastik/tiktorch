...
_MODELSESSION.fields_by_name['scale'].message_type = _TENSORDIM
_MODELSESSION.fields_by_name['offset'].message_type = _TENSORDIM
...
TensorDim = _reflection.GeneratedProtocolMessageType('TensorDim', (_message.Message,), {
