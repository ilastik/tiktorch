...
class _ArrayLike(Generic[_S]):
    ...
    def all(
        self, axis: AxesType = None, out: "_ArrayLike[_U]" = None, keepdims: bool = False
    ) -> Union["_ArrayLike[_U]", "_ArrayLike[bool]"]: ...
    def any(
        self, axis: AxesType = None, out: "_ArrayLike[_U]" = None, keepdims: bool = False
    ) -> Union["_ArrayLike[_U]", "_ArrayLike[bool]"]: ...
    def argmax(self, axis: int = None, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_U]", "_ArrayLike[int]"]: ...
    def argmin(self, axis: int = None, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_U]", "_ArrayLike[int]"]: ...
    def argpartition(
        self,
    ...
    def argsort(self, axis: int = None, kind: str = "quicksort", order: OrderType = None) -> "_ArrayLike[int]": ...
    def astype(
        self, dtype: Any, order: str = "K", casting: str = "unsafe", subok: bool = True, copy: bool = False
    ) -> "_ArrayLike[Any]": ...
    def byteswap(self, inplace: bool = False) -> "_ArrayLike[_S]": ...
    def choose(
        self, choices: Sequence["_ArrayLike[_V]"], out: "_ArrayLike[_U]" = None, mode: str = "raise"
    ) -> Union["_ArrayLike[_U]", "_ArrayLike[_V]"]: ...
    def clip(
        self, a_min: Any, a_max: Any, out: "_ArrayLike[_U]" = None
    ) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def compress(
        self, condition: Sequence[bool], axis: int = None, out: "_ArrayLike[_U]" = None
    ) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def conj(self) -> "_ArrayLike[_S]": ...
    def conjugate(self) -> "_ArrayLike[_S]": ...
    def copy(self, order: str = "C") -> "_ArrayLike[_S]": ...
    def cumprod(self, axis: int = None, dtype: Any = None, out: "_ArrayLike[Any]" = None) -> "_ArrayLike[Any]": ...
    def cumsum(self, axis: int = None, dtype: DtypeType = None, out: "_ArrayLike[Any]" = None) -> "_ArrayLike[Any]": ...
    ...
    def max(self, axis: AxesType = None, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def mean(
        self, axis: AxesType = None, dtype: Any = None, out: "_ArrayLike[_U]" = None, keepdims: bool = False
    ) -> "_ArrayLike[floating]": ...
    def min(self, axis: AxesType = None, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def newbyteorder(self, new_order: str = "S") -> "_ArrayLike[_S]": ...
    def nonzero(self) -> "_ArrayLike[int]": ...
    def partition(self, kth: AxesType, axis: int = -1, kind: str = "introselect", order: OrderType = None) -> None: ...
    def prod(
        self, axis: AxesType = None, dtype: DtypeType = None, out: "_ArrayLike[_U]" = None, keepdims: bool = False
    ) -> "_ArrayLike[Any]": ...
    def ptp(self, axis: int = None, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def put(self, ind: "_ArrayLike[int]", v: "_ArrayLike[_S]", mode: str = "raise") -> None: ...
    def ravel(self, order: str = "C") -> "_ArrayLike[_S]": ...
    def repeat(self, repeats: Union[int, Sequence[int]], axis: int = None) -> "_ArrayLike[_S]": ...
    def reshape(self, newshape: ShapeType, order: str = "C") -> "_ArrayLike[_S]": ...
    def resize(self, new_shape: ShapeType, refcheck: bool = True) -> None: ...
    def round(self, decimals: int = 0, out: "_ArrayLike[_U]" = None) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    def searchsorted(
        self, v: Union[_S, "_ArrayLike[_S]"], side: str = "left", sorter: "_ArrayLike[int]" = None
    ) -> "_ArrayLike[int]": ...
    def setfield(self, val: Any, dtype: DtypeType, offset: int = 0) -> None: ...
    def setflags(self, write: bool = None, align: bool = None, uic: bool = None) -> None: ...
    ...
    def take(
        self, indices: Sequence[int], axis: int = None, out: "_ArrayLike[_U]" = None, mode: str = "raise"
    ) -> Union["_ArrayLike[_S]", "_ArrayLike[_U]"]: ...
    ...
    def trace(
        self, offset: int = 0, axis1: int = 0, axis2: int = 1, dtype: DtypeType = None, out: "_ArrayLike[_U]" = None
    ) -> "_ArrayLike[Any]": ...
    ...
    def view(self, dtype: Union[DtypeType, Type["ndarray"]] = None, type: type = None) -> "_ArrayLike[Any]": ...
    #
    # Magic methods
    #
...
def array(
    object: Any, dtype: Any = None, copy: bool = True, order: str = None, subok: bool = False, ndmin: int = 0
) -> ndarray[Any]: ...
def asarray(a: Any, dtype: DtypeType = None, order: str = None) -> ndarray[Any]: ...
def asanyarray(
    a: Any, dtype: DtypeType = None, order: str = None
) -> ndarray[Any]: ...  # TODO figure out a way to restrict the return type
...
def frombuffer(
    buffer: Any, dtype: DtypeType = float, count: int = -1, offset: int = 0  # TODO figure out a way to restrict buffer
) -> ndarray[Any]: ...
def fromfile(
    file: object, dtype: DtypeType = float, count: int = -1, sep: str = ""
) -> ndarray[
    Any
]: ...  # TODO fix file definition (There's a bug in mypy io's namespace https://github.com/python/mypy/issues/1462)
def full(shape: ShapeType, fill_value: Any, dtype: DtypeType = None, order: str = "C") -> ndarray[Any]: ...
def full_like(
    a: Any, fill_value: Any, dtype: DtypeType = None, order: str = "C", subok: bool = True
) -> ndarray[Any]: ...
